                    ...
                    return (
                        ...
                        >
                            ...
                            <div className="flex gap-3">
                                <button className="bg-zinc-900 text-white px-4 py-2 cursor-pointer rounded-md hover:bg-zinc-950 transition-colors duration-200"  onClick={() => { handleUpdatePost(currElem) }}>
                                    Edit
                                </button>
